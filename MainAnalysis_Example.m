...
SaveDir = 'H:\MatchingUnits\Output\Concatenated1Day'; %'H:\MatchingUnits\Output\MonthApartStitched'%'H:\MatchingUnits\Output\NotConcatenated %%;%  'H:\MatchingUnits\Output\ManyRecordings'%Folder where to store the results
