...
SaveDir = 'H:\MatchingUnits\Output\NotConcatenated';%'H:\MatchingUnits\Output\Concatenated1Day'; % 'H:\MatchingUnits\Output\ManyRecordings'%Folder where to store the results
...
MiceOpt = {'AL032'};%{'AL032','AV008','CB016','EB019','JF067'}; % Add all mice you want to analyze
