...
SaveDir = 'H:\MatchingUnits\Output\ManyRecordings' % Folder where to store the results
...
MiceOpt = {'JF067'};%{'AL032','AV008','CB016','EB019','JF067'}; % Add all mice you want to analyze
