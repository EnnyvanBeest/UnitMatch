...
% sure your 'KSDir' contains a subfolder called 'RawWaveforms'. There
...
%% User input: 
SaveDir = '\\path\to\save'; % Recommended to use end this path with \Probe0\IMRO_1\ if more probes/IMRO tables were used or \AllProbes\AllIMRO\ otherwise
...
ComputeFunctionalScores(fullfile(UMparam.SaveDir,'UnitMatch')) % Only works when having access to Kilosort output (e.g. spike times etc.) 
