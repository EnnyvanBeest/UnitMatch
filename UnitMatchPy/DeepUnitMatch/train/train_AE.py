...
def run(args):
    ...
    np_dataset = AE_NeuropixelsDataset_cortexlab(root=np_root, batch_size=args.batchsize)
...
def run_training(exp_name, dataset, lr=1e-5, save_freq=1, total_epoch=300, 
                 cont=False, batchsize=32):
    """
